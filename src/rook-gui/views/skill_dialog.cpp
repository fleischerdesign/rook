...
inline void SkillDialog::init(Class *)
{
    ...
    name_entry->set_placeholder_text(_("e.g. typescript-style"));
    m_name_entry = name_entry;
    content->append(std::move(name_entry));

    auto desc_label = Gtk::Label::create(_("Description:"));
    desc_label->set_xalign(0.0f);
    content->append(std::move(desc_label));

    auto desc_entry = Gtk::Entry::create();
    desc_entry->set_placeholder_text(_("Brief description of what this skill does"));
    m_desc_entry = desc_entry;
    content->append(std::move(desc_entry));

    auto prompt_label = Gtk::Label::create(_("Prompt:"));
    ...
    auto always_label = Gtk::Label::create(_("Always ON in new chats:"));
    ...
    auto save = Gtk::Button::create_with_label(_("Save Skill"));
